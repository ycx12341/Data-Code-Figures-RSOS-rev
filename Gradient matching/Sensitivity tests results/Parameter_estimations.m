...
% circumstances of the sensitivity tests mentioned in Xiao et al.
...
paras_cons_dndm = readtable('Parameters means at all CV level dn dm fixed.txt');
paras_cons_dngamma = readtable('Parameters means at all CV level dn gamma fixed.txt');
paras_cons_dngammarn = readtable('Parameters means at all CV level dn gamma rn fixed.txt');
